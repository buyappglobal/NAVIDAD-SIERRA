      ...
      <div className="bg-slate-800 rounded-lg shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
        <div className="flex justify-between items-center p-4 border-b border-slate-700">
          <div className="flex items-center gap-3">
            {ICONS.magic}
            <h2 className="text-2xl font-display text-amber-300">Añadir Eventos con IA</h2>
          </div>
        ...
        <div className="p-6 space-y-4 overflow-y-auto flex-1">
          ...
          <div>
            <label htmlFor="event-text" className="block mb-2 text-sm font-medium text-slate-300">Texto con los eventos</label>
            <textarea
              id="event-text"
              name="event-text"
              rows={10}
              ...
              className="w-full p-2 bg-slate-900 border border-slate-600 rounded-md focus:ring-amber-400 focus:border-amber-400"
        ...
        <div className="flex justify-end items-center gap-4 p-4 border-t border-slate-700 bg-slate-800/50">
          <button type="button" onClick={onClose} className="bg-slate-600 text-white font-bold py-2 px-6 rounded-md hover:bg-slate-500 transition-colors" disabled={isLoading}>
            Cancelar
          </button>
          <button
            type="button"
            onClick={handleSubmit}
            className="bg-purple-600 text-white font-bold py-2 px-6 rounded-md hover:bg-purple-500 transition-colors flex items-center gap-2 disabled:bg-purple-800 disabled:cursor-not-allowed"
